...
const resend = new Resend('re_7F1wyCJ4_HRh1PNVMTfPiNWL9VqPeCTCj');
...
async function sendPasswordResetEmail(email, token) {
  ...
  const transporter = await resend.emails.send({
    ...
    from: "Tickify <support@tickifyonlinea.online>",
    to: email,
    subject: 'Recuperación de contraseña',
    html: `<h1>Recibimos una solicitud para restablecer tu contraseña. A continuación, encontrarás un código de verificación que deberás ingresar 
